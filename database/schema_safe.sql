-- Safe database schema for Finance Tracker
-- SQLite database setup with migration-safe statements
...
-- Create transactions table (basic version for compatibility)
...
-- Create safe indexes (only on columns that always exist)
